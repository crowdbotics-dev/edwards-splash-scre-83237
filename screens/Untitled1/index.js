...
const Untitled1 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }} style={styles.AKJXaQgx}><View style={styles.GQkujbeX}><ImageBackground style={styles.INTyQNyG} source={require("./test_image.png")} resizeMode="cover"></ImageBackground></View><ImageBackground style={styles.CxJnDhma} source={{
      ...
      }} resizeMode="cover"><Text style={styles.CgtZNuSl}>{"Welcome to the Future"}</Text></ImageBackground></ScrollView>
    </SafeAreaView>;
};
