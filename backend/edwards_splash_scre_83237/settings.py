"""
Django settings for edwards_splash_scre_83237 project.
...
ROOT_URLCONF = 'edwards_splash_scre_83237.urls'
...
WSGI_APPLICATION = 'edwards_splash_scre_83237.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "edwards_splash_scre_83237 API",
    "DESCRIPTION": "API documentation for edwards_splash_scre_83237 App",
    "VERSION": "v1",
}
