...
## Project Structure
    ...
    ├── edwards_splash_scre_83237  # Django project configurations
...
1. Clone this repo and `cd edwards_splash_scre_83237`
...
2. Clone this repo and `cd edwards_splash_scre_83237`
